local S = mobs_monster_mese_monster
...
local mese_monster_types = {
						...
						immune_to = {
									{"default:pick_wood", 0},{"default:shovel_wood", 0},{"default:axe_wood", 0},{"default:sword_wood", 0},
									{"default:pick_stone", 0},{"default:shovel_stone", 0},{"default:axe_stone", 0},{"default:sword_stone", 0}									
								},
						drops = {
						...
						immune_to = {
									{"default:pick_wood", 0},{"default:shovel_wood", 0},{"default:axe_wood", 0},{"default:sword_wood", 0},
									{"default:pick_stone", 0},{"default:shovel_stone", 0},{"default:axe_stone", 0},{"default:sword_stone", 0},
									{"default:pick_bronze", 0},{"default:shovel_bronze", 0},{"default:axe_bronze", 0},{"default:sword_bronze", 0}									
								},
						drops = {
						...
						immune_to = {
									...
									{"default:pick_stone", 0},{"default:shovel_stone", 0},{"default:axe_stone", 0},{"default:sword_stone", 0},
									{"default:pick_bronze", 0},{"default:shovel_bronze", 0},{"default:axe_bronze", 0},{"default:sword_bronze", 0},
									{"default:pick_steel", 0},{"default:shovel_steel", 0},{"default:axe_steel", 0},{"default:sword_steel", 0}									
								},
						drops = {
...
mobs:register_mob("mobs_monster_mese_monster:mese_monster", {
	type = "monster",
	...
	reach = 4,
	shoot_interval = 0.5,
	arrow = "mobs_monster_mese_monster:mese_arrow",
	shoot_offset = 0.75,
	knock_back = true,
	hp_min = 10,
	hp_max = 25,
		...
		on_spawn = function(self)
			...
			if not set then
				...
				for i, obj in ipairs(objects) do
					if minetest.is_player(obj) and 
					obj:get_wielded_item():get_name() == "mobs_monster_mese_monster:mese_monster" then
			...
			if not set then
				local ran_sel = math.random(1,4)
				local def = mese_monster_types[ran_sel]
...
-- mese arrow (weapon)
minetest.register_craftitem("mobs_monster_mese_monster:mese_crystal_fragment_arrow", {
	description = S("Mese Monster Arrow"),
	inventory_image = "mobs_monsters_mese_crystal_fragment.png",
	groups = {not_in_creative_inventory = 1},
})


mobs:register_arrow("mobs_monster_mese_monster:mese_arrow", {
	visual = "wielditem",
	visual_size = {x = 0.25, y = 0.25},
	textures = {"mobs_monster_mese_monster:mese_crystal_fragment_arrow"},
	velocity = 8,
    rotate = 180,
